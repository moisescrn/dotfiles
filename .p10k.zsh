# Generated by Powerlevel10k configuration wizard on 2025-12-14 at 22:34 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    vcs                     # git status
    context
    command_execution_time  # these two are personal additions, used to show things like vpn and execution time (e.g.: of vpn or of root session) || I am not so sure about them
    status
